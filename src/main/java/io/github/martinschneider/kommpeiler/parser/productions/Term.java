...
public class Term extends IntFactor {
  ...
  // {
  // instructionList.add(new Instruction(cmd, this.getLeft().getRegisterNr(),
  // this.getLeft().getRegisterNr(),
  ...
  //
  // instructionList.add(new Instruction(cmd, this.getLeft().getRegisterNr(),
  // this.getLeft().getRegisterNr(), this.getRight().getRegisterNr()));
  //
  // this.setValueType(ValueType.REGISTER);
  // this.setRegisterNr(this.getLeft().getRegisterNr());
  // this.getLeft().setValueType(ValueType.MEMORY);
  ...
  //
  // instructionList.add(new Instruction(cmd,
  // this.getLeft().getRegisterNr(), this.getLeft().getRegisterNr(),
  // (Integer)this.getRight().getValue()));
  //
  // this.setValueType(ValueType.REGISTER);
  // this.setRegisterNr(this.getLeft().getRegisterNr());
  // this.getLeft().setValueType(ValueType.MEMORY);
  ...
  // {
  // instructionList.add(new Instruction(cmd, this.getLeft().getRegisterNr(),
  // this.getLeft().getRegisterNr(), (Integer)this.getRight().getValue()));
  //
  // this.setValueType(ValueType.REGISTER);
  // this.setRegisterNr(this.getLeft().getRegisterNr());
  // this.getLeft().setValueType(ValueType.MEMORY);
