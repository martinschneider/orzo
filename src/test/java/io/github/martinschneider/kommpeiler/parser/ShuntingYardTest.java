...
public class ShuntingYardTest {
  ...
  public void testExpressionParsing() {
    List<Token> input = List.of(new IntNum(5), new Operator(Operators.PLUS), new IntNum(7),
        new Operator(Operators.DIV), new IntNum(2));
    List<Token> output = List.of(new IntNum(5), new IntNum(7), new IntNum(2),
        new Operator(Operators.DIV), new Operator(Operators.PLUS));
